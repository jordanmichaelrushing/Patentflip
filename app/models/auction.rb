class Auction < ActiveRecord::Base
  ...
  :pat_num, :pat_off_desc, :pat_type, :timer_day, :timer_hr, :timer_min, :title,
	...
	has_attached_file :pic1, styles: { a: "600>", tiny: "250x250>" }
  has_attached_file :pic2, styles: { a: "600>", tiny: "250x250>" } 
  has_attached_file :pic3, styles: { a: "600>", tiny: "250x250>" }
  has_attached_file :pic4, styles: { a: "600>", tiny: "250x250>" }
  has_attached_file :pic5, styles: { a: "600>", tiny: "250x250>" }
  has_attached_file :vid, styles: { large: { geometry: "1920x1080>", 
    format: 'flv' }}, default: "", processors: [:ffmpeg]
